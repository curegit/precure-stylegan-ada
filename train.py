...
def parse_args():
	...
	group.add_argument("-r", "--r1-gamma", metavar="GAMMA", dest="gamma", type=ufloat, default=10, help="coefficient of R1 regularization (set 0 to disable)")
	...
	group.add_argument("-w", "--pl-weight", metavar="W", dest="weight", type=ufloat, default=2, help="coefficient of the path length regularization (set 0 to disable)")
